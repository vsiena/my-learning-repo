/* 
The standard js enviroment provies another data struture called Set.
...
Its construcutor creates an empty group, 
...
When add is called, it must check whether the given value is in the array 
or add it otherwise, posssibly using push.
...
Don't forget to overwrite the property holding the members 
with the newly filtered version of the array. 

The from method can use a for/of loop to get the values 
out of the iterable object and call add to put them into a newly created group.
